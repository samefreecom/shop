...
class AipBase {
    ...
    protected $appId = '30529778';

    protected $apiKey = 'fXIIn8tV9hx8zg6TaFg1IlFd';

    protected $secretKey = '2afzq5izs2tdaySGkwOVqIpqXmZceONB';
    /*

    protected $appId = '26444387';

    protected $apiKey = 'Vv64s2Cp34ZbYxOyxNT5kQ2k';

    protected $secretKey = 'ZQTrctBfOukSRCVHrxkf8A0ZvGs10lBs';
    */
    /**
     * 权限
     * @var array
